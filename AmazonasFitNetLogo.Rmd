...
```{r sim_simple449clusterRCP45theta110_59y, echo=FALSE, tidy=TRUE, message=FALSE, warning=FALSE, eval=TRUE}
...
```{r calcPatchDistSimRCP45theta110, echo=FALSE,message=FALSE,warning=FALSE,fig.align='center',eval=TRUE}
...
# -----------------------> alternative set of simulations to check  simExponentsAmazonRCP45_59y.rds
# 
