...
```{r sim_simple449postRCP85_deforest59_1, echo=FALSE, tidy=TRUE, message=FALSE, warning=FALSE, eval=TRUE}
...
# Previous simulations Amazon59years449PostRcp45_60 & Amazon59years449PostRcp45
#
nl@experiment <- experiment(expname="Amazon59years449PostRcp85_def1",
                            outpath=outpath,
                            repetition=1,
                            tickmetrics="true",
                            idsetup="setup",
...
sim <- read_netlogo_simul(file.path(outpath,"Amazon59years449PostRcp85_def1_distinct.csv"),skip=0)
#sim <- bind_rows(sim,read_netlogo_simul(file.path(outpath,"Amazon59years449PostRcp45_def2_distinct.csv"),skip=0))
