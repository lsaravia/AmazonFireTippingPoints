...
```{r sim_simple449postRCP45_deforest59_1, echo=FALSE, tidy=TRUE, message=FALSE, warning=FALSE, eval=TRUE}
...
# Previous simulations Amazon59years449PostRcp45_60 & Amazon59years449PostRcp45
#
nl@experiment <- experiment(expname="Amazon59years449PostRcp45_def1",
                            outpath=outpath,
                            repetition=1,
                            tickmetrics="true",
                            idsetup="setup",
...
# Add Data
#
pexp <- pexp %>% bind_rows(patch_sizes_p %>% mutate(theta=61,RCP="4.5"), patch_sizes_p %>% mutate(theta=61,RCP="8.5")) %>%  mutate(tot_patch= 100 * tot_patch, max_patch= max_patch*100, num_patch=100* num_patch) %>% filter(year>2000)## Make %
pexp %>% count(decade,theta)
