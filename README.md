...
* Code and Data for the paper
	...
	Saravia, L., Bond-Lamberty, B., & Suweis, S. (2021). Amazon fire regimes under climate change scenarios. 
	EcoEvoRxiv. https://doi.org/10.32942/osf.io/nr23w
...
* AmazonasFitNetLogo.Rmd: 
	...
	Using the **DynamicFireForest.nlogo** model available at [https://github.com/lsaravia/FireNL](https://github.com/lsaravia/FireNL), perform Latin hypercube sampling to calibrate the model and generate predictions through 2060.
